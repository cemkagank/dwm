/* https://github.com/cemkagank/dwm */
...
static const char *fonts[]          = { "Ubuntu:style=Light:antialias:true:hinting:true:size=12",
...
/* tagging */
static const char *tags[] = { "dev", "www", "sys", "doc", "vid", "mus", "7", "8", "9" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_dpg, "-sf", col_gray4, NULL };
